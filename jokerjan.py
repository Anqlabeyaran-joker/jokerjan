#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To jokerjan HaZara
...
\033[1;93m███▓▒░░._\033[1;97mLOVE JOKER\033[1;93m_.░░▒▓███►
...
\033[1;91mAuthor©\033[1;91m: \033[1;93mjokerjan

\033[1;91mYoutube\033[1;91m: \033[1;93mjokerjan.

\033[1;91mFacebook\033[1;91m: \033[1;93mhttps://www.facebook.com/asadullah.shirzad.56
\033[1;91m«--------------------\033[1;93m✧\033[1;91m--------------------»"""
jalan("\033[1;97m jokerjan LOVE JOKER cybertem love all of yours   ")
jalan('\033[1;97m Username joker Password jokerjan   ')
jalan('\033[1;97m██ 39%  ')
jalan("\033[1;91m ███ 49%  ")
jalan("\033[1;97m  ████ 76%  ")
jalan("\033[1;93m   █████ 89%  ")
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\x1b[1;91mToken invjokerjand"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	try:
		...
		keluar()
	os.system("clear") #Dev:I.m jokerjan haZara.
	print logo
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;97m«--------------------\033[1;92m✧\033[1;97m--------------------»"
	print "  \033[1;91m«---------Developed By Kajokerjanan------------»" #Dev:WE_ARE_ANONYMOUS.
             ...
             ( (  \.---./  ) )
              '.__/o   o\__.'
                 {=  ^  =}
                  >  -  <
.-------------.""`-------`"".-------------.
: \033[1;92m     LOVE JOKER..    \033[1;93m :
'-----------------------------------------' 
                ___)( )(___
               (((__) (__)))"""
